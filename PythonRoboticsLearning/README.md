...
- [MPC 模型预测控制笔记](./notes/07_model_predictive_control.md)
- [**DWA 动态窗口笔记**](./notes/dwa_algorithm.md) ← **最新**
...
### 2026-03-12
- ✅ 完成 DWA (Dynamic Window Approach) 深度学习
- ✅ 通过交互式问答完全掌握算法原理
- ✅ 创建超详细的算法笔记（包含数学模型、工作流程、参数调优）
- 📌 **完全理解**了 DWA 核心概念：
  - 动态窗口：物理约束与动态约束的交集
  - 三个代价函数：目标导向 + 速度激励 + 避障安全
  - 滚动优化：适应动态环境的关键机制
- 📌 掌握了局部路径规划的本质：实时性 vs 全局最优性的权衡
- 📌 理解了防卡死机制和参数调优策略
- 📌 **关键洞察**：
  - DWA 是典型的模型预测控制(MPC)思想应用
  - 航向误差比直接距离更适合导航
  - 代价函数权重直接影响机器人行为特性
